...
class CAVTextProcessor:
    ...
    def get_modelo(self) -> Union[str, None]:
        try:
            ...
            return found[0].replace(":", "").replace("nro.", "").replace("nro", "").strip().title()
    ...
    def get_nro_motor(self) -> Union[str, None]:
        try:
            ...
            if len(found) > 0:
                return found[0].replace("nro.", "").replace(":", "").strip().upper()
    ...
    def get_nro_chasis(self) -> Union[str, None]:
        try:
            ...
            # TODO: Probar con el otro caso...
                ...
                return num_chasis.replace(":", "").strip().upper()
