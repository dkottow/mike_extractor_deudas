...
from utils import standardize_word
    ...
    def get_forms(self) -> Dict[str, Any]:
        ...
        for page in self._pages:
            for field in page.form.fields:
                field_name = standardize_word(field.key.text)
                try:
    ...
    def get_tables(self) -> List[List[List[Any]]]:
        ...
        for page in self._pages:
            ...
            for table in page.tables:
                ...
                current_table = [[np.NAN] * num_cols for i in range(num_rows)]

                for r, row in enumerate(table.rows):
                    for c, cell in enumerate(row.cells):

                        current_table[r][c] = cell.text
